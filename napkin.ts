...
function generate(infile: string): any
function generate(options: ioptions): any
function generate(param: any): any {

    var options: ioptions;

    if (typeof param == "string") options = { infile: param }; else options = param;
...
function createPegJsNapkinParser() {
    ...
    function parse(input) {
        var options = arguments.length > 1 ? arguments[1] : {},
            ...
            peg$c55 = function (i) { return i.join("") === indent; },
            peg$c56 = function (i) { return i.length > indent.length; },
            peg$c57 = function (i) { indentStack.push(indent); indent = i.join(""); var pos = offset; },
            peg$c58 = function (i) { indentStack.push(indent); indent = i.join(""); peg$currPos = offset(); },
            peg$c59 = function () { indent = indentStack.pop(); },
